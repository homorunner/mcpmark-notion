    ...
    for i in range(1, 11):
        ...
        try:
            ...
            if uppercase_content != expected_uppercase:
                print(
                    f"❌ File '{filename}' content is not properly converted to uppercase"
                )
                return False
...
def main():
    ...
    try:
        ...
        # test_dir = Path("/Users/chenlingjun/Desktop/MCP/MCPMark/.mcpmark_backups/backup_filesystem_file_context_uppercase_53670")
